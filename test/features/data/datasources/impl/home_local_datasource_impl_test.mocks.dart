...
// in elevate_bootcamp_c6_clean_arch/test/features/data/datasources/impl/home_local_datasource_impl_test.dart.
...
import 'package:elevate_bootcamp_c6_clean_arch/core/base/decoder.dart' as _i7;
...
/// A class which mocks [Decoder].
///
/// See the documentation for Mockito's code generation for more information.
class MockDecoder extends _i1.Mock implements _i7.Decoder {
  MockDecoder() {
    _i1.throwOnMissingStub(this);
  }
  ...
  Map<String, dynamic> decode(String? source) =>
      (super.noSuchMethod(
            Invocation.method(#decode, [source]),
